...
const Sidebar = ({ name, role, onSelect }) => {
  ...
  return (
    <aside className="bg-white dark:bg-gray-900 text-black dark:text-white w-64 fixed h-full flex flex-col justify-between">      <div>
      ...
      <div className="p-6">
        <button className="bg-white text-gray-900 w-full py-2 rounded mb-3">
          Download Resume
        </button>
        <a
          href="mailto:sribremji1994@gmail.com?subject=Let's Connect&body=Hi Sri Bremji,%0D%0A%0D%0AI found your resume interesting and would like to get in touch with you."
